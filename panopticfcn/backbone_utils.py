...
from .custom_fpn import GuidedPAKAFPN
...
def build_resnet_guidedpakafpn_p5_backbone(cfg, input_shape: ShapeSpec):
    """
    Build ResNet-FPN backbone with P6 and P7 from P5 feature.
...
def build_backbone(cfg, input_shape=None):
    ...
    backbone = build_resnet_guidedpakafpn_p5_backbone(cfg, input_shape)
