...
def add_panopticfcn_config(cfg):
    ...
    ### 내가 추가 ###
    cfg.MODEL.GUIDANCE_OUTPUT_STRIDES = [8,16,32]

    cfg.MODEL.NEIGHBOR_HEAD = CN()
    cfg.MODEL.NEIGHBOR_HEAD.CONV_DIMS = 256
    cfg.MODEL.NEIGHBOR_HEAD.NUM_NEIGHBOR = 9
    cfg.MODEL.NEIGHBOR_HEAD.NUM_CONVS = 3
    cfg.MODEL.NEIGHBOR_HEAD.DILATIONS = [1] #[1,2,4,8]
    cfg.MODEL.NEIGHBOR_HEAD.NORM = "GN"
    cfg.MODEL.NEIGHBOR_HEAD.LOSS_FUNC = 'sigmoid_focal_loss'

    cfg.MODEL.SEMANTIC_HEAD = CN()
    cfg.MODEL.SEMANTIC_HEAD.CONV_DIMS = 256
    cfg.MODEL.SEMANTIC_HEAD.NUM_CLASSES = cfg.MODEL.POSITION_HEAD.THING.NUM_CLASSES  \
                                            + (cfg.MODEL.POSITION_HEAD.STUFF.NUM_CLASSES -1)
    cfg.MODEL.SEMANTIC_HEAD.NUM_CONVS = 3
    cfg.MODEL.SEMANTIC_HEAD.NORM = "GN"
    cfg.MODEL.SEMANTIC_HEAD.LOSS_FUNC = 'DeepLab'
    cfg.MODEL.SEMANTIC_HEAD.SMALL_INSTANCE_AREA_IN_OS1 = 4096
    cfg.MODEL.SEMANTIC_HEAD.SMALL_INSTANCE_WEIGHT = 5

    cfg.MODEL.SEMANTIC_FPN.OUTPUT_STRIDES = [4,8,16,32]
